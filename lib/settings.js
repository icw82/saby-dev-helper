...
const getGenieMeta = s3cldPath => {
    ...
    const stand = genieMeta.Stands.find(stand => relative(resolve(s3cldPath), resolve(stand.CloudFile)) === '');
...
const getSettings = () => {
    ...
    console.log('Stand meta:', genieMeta);
    ...
    locals.dest = resolve('C:\\tz\\projects\\20.2100\\server');
